...
export default function HomePage() {
  ...
  return (
    <div style={{ background: "linear-gradient(135deg, #110A1C, #1A0D2E, #0A1C2A)", backgroundAttachment: "fixed", margin: 0, minHeight: "100vh", fontFamily: "sans-serif", paddingBottom: "30px" }}>
      ...
      <div style={{ display: isMenuOpen ? "block" : "none", backgroundColor: "#0D0D0D", position: "fixed", top: 0, left: 0, width: "75%", maxWidth: "300px", height: "100%", zIndex: 9999, paddingTop: "60px", overflowY: "auto" }}>
        ...
        <div style={{ padding: "20px 25px 30px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", alignItems: "center", flexWrap: "wrap" }}>
            ...
            <a href="https://t.me/Imala_kaayoo" target="_blank" rel="noreferrer" style={{ width: "42px", height: "42px", background: "#229ED9", borderRadius: "50%", display: "flex", alignItems: "center", justify-content: "center" }}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="white"><path d="M21.198 2.433a2.242 2.242 0 0 0-1.022.215l-16.5 7.5a2.25 2.25 0 0 0 .126 4.073l3.9 1.205 1.312 4.282a1.5 1.5 0 0 0 2.56.5l1.91-2.348 3.96 2.916a2.25 2.25 0 0 0 3.528-1.306l2.7-13.5a2.25 2.25 0 0 0-2.474-2.537zM9.9 14.85l-.738 3.43-.738-2.41 6.9-6.63-6.424 5.61z"/></svg></a>
            <a href="https://t.me/rised_official" target="_blank" rel="noreferrer" style={{ width: "42px", height: "42px", background: "#1A6C9E", borderRadius: "50%", display: "flex", alignItems: "center", justify-content: "center" }}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="white"><path d="M20 2H4a2 2 0 0 0-2 2v18l4-4h14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z"/></svg></a>
            <a href="https://wa.me/251923489484" target="_blank" rel="noreferrer" style={{ width: "42px", height: "42px", background: "#25D366", borderRadius: "50%", display: "flex", alignItems: "center", justify-content: "center" }}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="white"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413z"/></svg></a>
          </div>
        </div>
      </div>
      ...
      {/* Grid - 2 Columns (Dizaayini kee sirriidha) */}
